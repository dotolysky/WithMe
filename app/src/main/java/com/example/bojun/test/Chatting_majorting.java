...
public class Chatting_majorting extends Activity {
    TextView showText;
    Button Button_send;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_chatting_majorting);
        ...
        threadList = new LinkedList<Chatting_majorting.SocketClient>();
